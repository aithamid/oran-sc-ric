...
ue1 = UE(ip="10.45.1.2", ueid="1", gnbid="gnbd_001_001_00000213_0")
ue2 = UE(ip="10.45.1.3", ueid="0", gnbid="gnbd_001_001_00000213_0")
    ...
    def start(self):
        while self.running:
            ...
            if len(self.attackers) > 0:
                print(f"\033[31mThere is attack \033[0m")
                self.change_resources(ue1.ip, DECREASE)
                self.change_resources(ue2.ip, DECREASE)
                self.change_resources(virtual.ip, DECREASE)
